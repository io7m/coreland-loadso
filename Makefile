...
instchk instchk.o insthier.o loadso-conf loadso-conf.o loadso.a loadso_close.o \
loadso_error.o loadso_func.o loadso_open.o loadso_sym.o
...
loadso_func.o:\
cc-compile loadso_func.c _sd-ptr_uint.h loadso.h
...
obj_clean:
	...
	instchk.o insthier.o loadso-conf loadso-conf.o loadso.a loadso_close.o \
	loadso_error.o loadso_func.o loadso_open.o loadso_sym.o
ext_clean:
